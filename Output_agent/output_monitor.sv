class counter_output_monitor extends uvm_monitor;
  ...
  task monitor();
    ...
    output_mon_pkt.data_out = rdmn_if.output_mon_cb.data_out;

    `uvm_info(get_type_name(),
      $sformatf("Output monitor has captured below transaction \n%s",
